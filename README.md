...
| ETF 自身資金動向 | 32 檔主動式 ETF 當日被三大法人買賣超的金額排行 |
...
| 投信 | ETF | 資料來源 |
|------|-----|----------|
| 野村 | 00980A、00985A、00999A | ETF 專區 GetFundAssets API |
| 統一 | 00403A、00411A、00981A、00988A | ETF 專區申購買回清單 GetPCF API |
| 群益 | 00982A、00992A、00997A | ETF 專區申購買回清單 buyback API |

尚未介接：中信、安聯、國泰、摩根、富邦、凱基、第一金、復華、永豐、台新、元大、
兆豐、聯博（合計 22 檔）。
